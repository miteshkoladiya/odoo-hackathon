...
export default function TimeOffPage() {
  ...
  const [balances, setBalances] = useState({ paid: 0, sick: 0 }) // Default 0 until loaded
    ...
    try {
      ...
      if (data.employees && data.employees.length > 0) {
         ...
         if (me && me.leaveBalances) {
            setBalances(me.leaveBalances)
         } else {
             setBalances({ paid: 24, sick: 7 })
         }
      }
    } catch (e) {
            ...
            <Card>
              <CardContent className="p-4 flex justify-between items-center">
                 <div>
                    ...
                    <h3 className="text-2xl font-bold text-blue-600">24 Days</h3>
                 </div>
            ...
            <Card>
              <CardContent className="p-4 flex justify-between items-center">
                 <div>
                    ...
                    <h3 className="text-2xl font-bold text-blue-600">07 Days</h3>
                 </div>
                 <span className="text-xs text-gray-400">Available</span>
              </CardContent>
            </Card>
